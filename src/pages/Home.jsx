                ...
                <div className="content">
                    <div className="home">
                        <div className="top-bit">
                            <div className="inner">
                                ...
                                <p>
                                    ...
                                    <br/>
                                    <br/>
                                    This weekend-long event is for everyone who is committed to make Northland an even
                                    better place to live.
                                    <br/>Together, we will brainstorm workable solutions to the problems that you see in
                                    our
                                    community and support the best ideas to become a reality.
                                    <br/>
                                    <br/>
                        ...
                        <p className="blue-text" id="middle-text">
                            The hardest part of bringing change forward is to find people who are as passionate and
                            motivated as you are.
                            At our innovation weekend, you’ll be immersed in the ideal environment to make change
                            happen.
                        </p>

                        <div className="cards">
                            <CardBorderless title="Tell Your Story" imageLocation={talk_1}>
                                Bring the challenges your community faces in front of an audience of like-minded people,
                        ...
                        <div className="schedule">
                            ...
                            <div className="cards-schedule">
                                <Card imageLocation={introductions} title="Introductions">
                                    Get to know the talent in the room. Listen to success stories from Tai Tokerau’s
                                    own.
                                </Card>
                                ...
                                <Card imageLocation={choose_proj} title="Choose Your Project">
                                    Out of the top ideas – which one do you like best? Choose which one you’ll work on
                                    over
                                    the weekend.
                                </Card>
                                <Card imageLocation={team} title="Build Your Team">
                                    Whether it’s your idea or someone else’s, you’ll create a cross-functional team to
                                    work
                            ...
                            <div className="cards-schedule">
                                <Card imageLocation={get_support} title="Get Support">
                                    Local mentors will be coming in throughout the event to coach you through the
                                    challenges
                                    and provide support.
                                </Card>
                                <Card imageLocation={story} title="Get To Work">
                                    We’ve got the resources and support in place to make things happen in a short period
                                    of
                                    time.
